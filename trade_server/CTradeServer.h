...
public:
    ...
    void start();
    void addRegionConnection(const string& region, const weak_ptr<Connection>& connection);
...
private:
    void handleRegionConnection(const shared_ptr<Connection>& connection, const bs::error_code& er);
